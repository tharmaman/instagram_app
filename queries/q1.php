...
<html>
  ...
  <body bgcolor="#fafafa">
    ...
    <div id="feed">
      ...
      // query for the data
      $sql      = 'SELECT u.userName, cm.postID ,mf.filepath
        ...
        while ($newArray=mysqli_fetch_array($res,MYSQLI_ASSOC))
          {
            ...
            if (strpos($newArray['filepath'],'pics') !== false) {
              echo "<img src='http://localhost:8888/".$newArray['filepath']."' width = '536' height = '479'><br> </div> <br> <br> <br> <br>";
            }
            // for video media files
            elseif (strpos($newArray['filepath'],'vids') !== false) {
              echo "<video src='http://localhost:8888/".$newArray['filepath']."' width = '536' height = '479' controls><br> </div> <br> <br> <br> <br>";
            }
          }
      }
      else {
