...
<html>
  ...
  <body bgcolor="#fafafa">
    ...
    <div id="feed">
      ...
      $sql      = 'SELECT u.userName, m.content, m.storyID, m.postID, m.timeSent FROM users u, messages m, conversations c WHERE u.userID = m.senderID AND m.convID = c.convID AND c.convID =
        (
          SELECT convID FROM
          (
        ...
        while ($newArray=mysqli_fetch_array($res,MYSQLI_ASSOC))
          {
            echo "<div class = 'feedBlock'>
                    ...
                    <div class = 'message'>".$newArray['content']."
                    </div>
                  </div>";
            }
          }
